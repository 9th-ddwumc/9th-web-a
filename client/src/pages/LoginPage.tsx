...
export default function LoginPage() {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      // AuthContext의 login 함수 사용 (내부에서 API 호출)
      await login({
        email: values.email,
        password: values.password,
      });

      // 로그인 성공 시 AuthContext에서 리다이렉트 처리됨
          ...
          <div className="flex flex-col items-center">
            <div className="mb-5 inline-flex size-16 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-fuchsia-500">
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" className="text-white">
                <path
                  fill="currentColor"
                  d="M17 8h-1V6a4 4 0 10-8 0v2H7a2 2 0 00-2 2v8a2 2 0 002 2h10a2 2 0 002-2v-8a2 2 0 00-2-2Zm-6 0h2V6a2 2 0 10-4 0v2Zm6 12H7v-8h10v8Z"
                />
              </svg>
            </div>
...
function EyeOffIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M2 4.27 3.28 3 21 20.72 19.73 22l-3.13-3.13A10.9 10.9 0 0112 19C5 19 2 12 2 12a20.4 20.4 0 014.48-5.88L2 4.27ZM12 7a5 5 0 014.58 2.86l-1.46 1.46A2.5 2.5 0 009.68 11l-1.5-1.5A5 5 0 0112 7Zm0 10a5 5 0 01-5-5c0-.38.05-.75.15-1.11l7 7c-.36.1-.73.11-1.11.11Z"
      />
    </svg>
  );
}